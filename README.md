...
#### 黑坑散炮
1. 开制方法：
   颗粒比较硬，吸水时间长，但是还是需要足够的水。开制散炮不易太用力，防止破坏散炮状态。加水慢慢加进去，能让状态保持更好。一定要有足够的吸水时间。
   散炮，一定需要调整好状态。控制炸开水层，黑坑容易出现鱼起浮。也有一些需要钓浮的鱼。底部没口，就尝试行程，底接之类的。
   散炮，颗粒，可以配合粗颗粒，细颗粒，以及一些轻麸之类的额。调整雾化，比重，散落。非常有讲究，需要有能够精准控制的能力。
2. 上饵技巧：
   上饵，用4指上饵，保证饵料的同心度，相对于鱼线。这样散落是均匀的，并且抛投也不容易钓。
   除此之外，散炮上的位置一般位于钩子上方，可以选择底钩，这样不影响钓目，也可以选择上钩，使得散落更快。
3. 抛竿技巧：
   带散炮的抛竿，一定要确定钓点位置，防止窝子坐远。
   手法上，是荡出去的，手拖住散炮，杆子听起来，子线盒主线要在一条直线上，这样荡出去。如果不在一条直线上，非常容易因为子线甩掉散炮。
4. 散炮频率：
   散炮的频率，并不是越快越好。要根据鱼情。主要分为：鱼口多，要杆杆带，鱼口少，开几杆子带一个小炮。糗鱼。
...
四. 冬
冬季做钓，最本质上，就是鱼口弱，张口小，吸力弱，活力小。

1. 饵料，比重需要小一点。味型需要大一点。抛投需要精准，窝量要小，钩饵不易过大。【针对，张口小，和吸力】
2. 线组，细子线有明显的好处。主线浮漂吃铅和水深匹配即可。【针对吸力】
3. 浮漂的漂型，如果是小漂，建议带行程的漂，大漂，建议细长身的漂。小漂考虑行程，大漂考虑出口。1.8算一个分界点。【针对吸力的可视情况，以及动态诱鱼】
4. 钩子，竞技秀，细条的那种。【针对吸力】
5. 调钓，基本的调钓就可以。所有配置都精良的情况下，合适的调钓也很容易调整出来。核心，就是漂尾粗细和钩饵重量的关系，对钩饵状态的把控。以及漂型和吃铅，对出口大小的影响。悬坠钓，直接调几钓几问题不大。漂尾细的话，可以再高一点。普通尾，调几钓几。完全没问题。调几钓几唯一的问题是，不确定钩饵到底了没有。粗漂尾，可以适当底一点钓目验证，然后调回，或者水底不平，直接钓目比调目底半目就行。【很对吸力，和浮漂钩饵配置】

另外，冬季钓鱼，适合玩竞技，钓小鱼，不要想着钓大鱼，钓远。安心享受钓鱼过程最好。以钓小鱼最舒服。当然有资源的话，再好不过。钓位的选择精进一点，不过还是在附近玩玩就好。
